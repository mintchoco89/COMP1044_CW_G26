...
<head>
	...
	<title>G26 Library - Search Book by ID</title>
...
<body>
	...
	<h2 class="page-title-heading">Search for a Book (by ID)</h2>
	...
	if(isset($_POST['submit'])) {
		...
		$book_id = $_POST['search-book-id'];
		$_SESSION['book_id'] = $book_id;
		
		$sql = "SELECT * FROM `book`,`category` WHERE book.book_id = '".$book_id."' AND book.category_id = category.category_id";
