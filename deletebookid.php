...
<head>
	...
	<title>G26 Library - Delete Book by ID</title>	
</head>
...
<body>
	...
	<h2 class="page-title-heading">Delete a Book (by ID)</h2>
	...
	$sql = "DELETE FROM book WHERE book_id = '".$_SESSION['book_id']."'";
		
	if($conn->query($sql) === TRUE) {
		echo "<p style='text-align: center; font-size: 150%; letter-spacing: 1px;'>Book deleted from library.</p>";
	} else {
