...
<head>
	...
	<title>G26 Library - Search Member by Name</title>
...
<body>
	...
	<h2 class="page-title-heading">Search for a Member (by Name)</h2>
	...
	if(isset($_POST['submit'])) {
		...
		$member_fname = $_POST['search-member-fname'];
		$member_lname = $_POST['search-member-lname'];
		
		
		$sql = "SELECT * FROM `member`,`type` WHERE member.firstname = '".$member_fname."' AND member.lastname = '".$member_lname."' AND member.type_id = type.type_id";
